...
public class AndroidRipperStarter implements RipperEventListener {
	...
	public void startRipping()
	{
		...
		if (conf != null)
		{
			...
			String schedulerClass = conf.getProperty("scheduler", ((driverType.equals("r"))?"it.unina.android.ripper.scheduler.RandomScheduler":"it.unina.android.ripper.scheduler.BreadthScheduler"));
